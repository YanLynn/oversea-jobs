...
<body>
	...
	<div class="invoice_wrapper">
		...
		<p class="text-right mb-3" style="margin-top:-10px;">請求書発行日&nbsp;&nbsp;&nbsp;{{ $data->payment->invoicedate }}</p> -->
		<div class="row">
			<div class="col-md-6 f-left" style="margin-top:5px;">
				<!-- <div class="p-name" style="width:75%;border-bottom:1px solid black;">
					{{-- <p><span class="text-underline">{{ $data->recruiter_name }}</span> 御中</p>
					<p>ご担当: {{ $data->incharge_name }}様</p> --}}
					<p style="float:left;line-height:20px;width:89%;margin-top:19px;margin-bottom:0px;">{{ $data->recruiter_name }}</p><p style="margin-top:19px;margin-bottom:0px;width:10%;text-align:right;float:right;line-height:20px;"> 様</p>
			...
			<div class="col-md-6 with-sign f-right">
				...
				<div class="company-info mb-2" style="margin-top: 20px;">
		...
		<table class="tbl-02 mb-4 invoice-table">
			...
			<tbody>
				<tr>
					...
					<td class="text-right" width="100px">{{ number_format($data->payment->default_amount) }}円</td>
					<td class="text-right" width="100px">{{ number_format($data->payment->default_amount) }}円</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
			...
			<tfoot>
				...
				<tr>
					...
					<td class="text-right" width="100px">{{ number_format($data->payment->tax) }}円</td>
					<td width="100px"></td>
				</tr>
				<tr>
					<td colspan="3" align="center">合計</td>
					<td class="text-right" width="100px">{{ number_format($data->payment->invoice_amount) }}円</td>
					<td width="100px"></td>
				</tr>
			</tfoot>
		</table>
