  ...
  <div class="login">   
      <div v-if="registeredUser" class="text-success" >Thank you {{registeredUser.name}}.You can now login</div>
        <div class="login-card-body">
            ...
            <form class="form-content" @submit.prevent="authenticate" v-if="this.$route.query.oe == null">                      
                <h3 class="form-signin-heading text-center recruiter-primary-color-txt"><span class="icon-login"></span>企業会員ログイン</h3>
            ...
            <div class="form-group mb-3">
              ...
              <div class="input-group">              
                 <input type="text" :class="['form-control',$v.formLogin.email.$error?'is-invalid':'']" name="メールアドレス" id="email" placeholder="メールアドレス" autocomplete="off"  v-model="$v.formLogin.email.$model" />
            ...
            <div class="form-content" v-else>
                <div class="success-email text-center">
                    <h3 class="form-signin-heading  recruiter-primary-color-txt ">Update Email Success!</h3>
                    <router-link class="btn searchbtn recruiter-primary-color" to="/recruiter/login">{{$t('menu.login')}}</router-link>
                </div>
