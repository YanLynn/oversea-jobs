<template>
    ...
    <div class="row col-12 text-center">        
        <div class="col-md-6 offset-md-3 inner-wrapper-right">
            <div class="successful-block">
                ...
                <a href="/" class="btn recruiter-primary-color primary-btn border-style btn-m">トップページへ</a>
                <!-- <button class="btn recruiter-primary-color primary-btn border-style">トップページへ</button> -->
            </div>
        </div>
    </div>
    <!--end successful-->
