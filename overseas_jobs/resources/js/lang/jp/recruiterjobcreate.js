export default {
    ...
    message_jobs_ex2 : ' 弊社はインドネシアジャカルタでWEBサイトを構築を行っております。',
    message_jobs_ex3 : ' この度事業拡張にともないスタッフの増強をおこないます。',
    message_jobs_ex4 : ' あなたの力をインドネシアで生かしてみませんか？',

    area : ' 勤務地 (検索用キーワード) ',
    area_select : ' 勤務地を選択',
    title_required : '求人タイトルは必須です',
